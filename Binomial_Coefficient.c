/*Q4. Develop a non-recursive function FACT(num) to find the factorial of a number, n!. 
Using this function, write a C program to compute the binomial coefficien Tabulate the 
